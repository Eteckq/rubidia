...
public class PathfinderGoalMeleeAttack extends PathfinderGoal {
    ...
    public void e() {
        ...
        if(entityliving != null){
            ...
            --this.h;
            if (this.e && this.h <= 0 && (this.i == 0.0D && this.j == 0.0D && this.k == 0.0D || entityliving.e(this.i, this.j, this.k) >= 1.0D || this.b.getRandom().nextFloat() < 0.05F)) {
