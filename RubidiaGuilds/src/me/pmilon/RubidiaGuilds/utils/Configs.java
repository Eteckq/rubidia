...
public class Configs {
	...
	public static void reloadGuildConfig() {
	    ...
	    Reader defConfigStream = new InputStreamReader(GuildsPlugin.instance.getResource("guilds.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        GuildsPlugin.guildConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadMembersConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(GuildsPlugin.instance.getResource("gmembers.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        GuildsPlugin.membersConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadRaidsConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(GuildsPlugin.instance.getResource("raids.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        GuildsPlugin.raidsConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadClaimsConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(GuildsPlugin.instance.getResource("claims.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        GuildsPlugin.claimsConfig.setDefaults(defConfig);
	    }
	}
