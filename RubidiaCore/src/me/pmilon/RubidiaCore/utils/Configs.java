...
public class Configs {
	...
	public static void reloadPlayerConfig() {
	    ...
	    Reader defConfigStream = new InputStreamReader(Core.instance.getResource("players.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        Core.playerConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadCitiesConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(Core.instance.getResource("cities.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        Core.cityConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadDatabase() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(Core.instance.getResource("database.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        Core.database.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadPathConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(Core.instance.getResource("paths.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        Core.pathConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadWeaponsConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(Core.instance.getResource("weapons.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        Core.weaponConfig.setDefaults(defConfig);
	    }
	}
	...
	public static void reloadCouplesConfig() {
	    ...
	    // Look for defaults in the jar
	    Reader defConfigStream = new InputStreamReader(Core.instance.getResource("couples.yml"));
	    if (defConfigStream != null) {
	        YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
	        Core.coupleConfig.setDefaults(defConfig);
	    }
	}
