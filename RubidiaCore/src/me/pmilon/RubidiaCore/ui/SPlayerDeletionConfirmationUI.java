...
public class SPlayerDeletionConfirmationUI extends ConfirmationUI {
	...
	public SPlayerDeletionConfirmationUI(RPlayer rp, SPlayer sp, int id) {
		super(rp.getPlayer(), ("Suppression de personnage"), new String[]{("§aSupprimer le personnage et perdre toute progression"),
				...
				"§7§l" + (sp.getRClass().getDisplayFr()),
				Arrays.asList("§8" + ("Niveau : ") + "§7§o" + sp.getRLevel(), "§8" + ("XP : ") + "§7§o" + sp.getRExp(), "§8" + ("Maîtrise : ") + "§7§o" + (sp.getMastery().getNameFR()), "§8" + ("Métier : ") + "§7§o" + ChatColor.stripColor((sp.getRJob().getNameFR())), "§8" + ("Points de compétence : ") + "§7§o" + sp.getSkp(), "§8" + ("Points de distinction : ") + "§7§o" + sp.getSkd(), "§8" + ("Force : ") + "§7§o" + sp.getStrength(), "§8" + ("Endurance : ") + "§7§o" + sp.getEndurance(), "§8" + ("Agilité : ") + "§7§o" + sp.getAgility(), "§8" + ("Intelligence : ") + "§7§o" + sp.getIntelligence(), "§8" + ("Perception : ") + "§7§o" + sp.getPerception(), "§8" + ("Meurtres : ") + "§7§o" + sp.getKills(), "§8" + ("Renom : ") + "§7§o" + sp.getRenom(), "", ("§e§oSouhaitez-vous vraiment supprimer ce personnage ?"), "", "§f§m----------------------------------------"));
		this.id = id;
	}
