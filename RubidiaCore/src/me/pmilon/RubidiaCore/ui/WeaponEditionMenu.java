...
public class WeaponEditionMenu extends UIHandler{
	...
	public UIType getType() {
		return UIType.WEAPONS_EDITION_MENU;
	}
	...
	private ItemStack getName(){
		...
		meta.setDisplayName(this.getWeapon().getRarity().getPrefix() + "§l" + this.getWeapon().getName());
	...
	private ItemStack getRarity(){
		...
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(this.getWeapon().getRarity().getPrefix() + this.getWeapon().getRarity().toString());
		item.setItemMeta(meta);
		return item;
	}
	private ItemStack getRClass(){
		...
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(this.getWeapon().getRClass().toString());
		item.setItemMeta(meta);
		return item;
	}
	...
	private ItemStack getMaxDmg(){
		...
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(String.valueOf(this.getWeapon().getMaxDamages()));
		item.setItemMeta(meta);
		return item;
	}
	private ItemStack getDropChance(){
		...
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(String.valueOf(this.getWeapon().getDropChance()));
		item.setItemMeta(meta);
		return item;
	}
	...
	private ItemStack getUse(){
		...
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(this.getWeapon().getWeaponUse().toString());
		item.setItemMeta(meta);
		return item;
	}
	private ItemStack getAtqSpd(){
		...
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName("attackSpeed: " + String.valueOf(this.getWeapon().getAttackSpeed()));
		item.setItemMeta(meta);
		return item;
	}
