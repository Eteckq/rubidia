...
public class Pet {
	...
	public Pet(String UUID, String name, int level, double exp, double health, int distinctionPoints, int ardor, int patience, int acuity, EntityType type, int age, boolean saddle, List<Pearl> activePearls, boolean active, DyeColor collarColor, Color color, Style style, int domestication, ItemStack armor, Rabbit.Type rabbitType, Ocelot.Type ocelotType, Parrot.Variant parrotType){
		this.uuid = UUID;
		this.name = name;
		this.level = level;
		this.exp = exp;
	...
	public void spawn(Player owner){
		...
		((LinkedHashSet)ReflectionUtils.getPrivateField("c", PathfinderGoalSelector.class, creature.targetSelector)).clear();
		((LinkedHashSet)ReflectionUtils.getPrivateField("b", PathfinderGoalSelector.class, creature.goalSelector)).clear();
		((LinkedHashSet)ReflectionUtils.getPrivateField("c", PathfinderGoalSelector.class, creature.goalSelector)).clear();
	    ...
	    if(pet instanceof Wolf){
        	...
        	((Ocelot) pet).setCatType(this.getOcelotType());
	...
	public void despawn(){
		...
		if(pet != null){
			if(pet instanceof Horse){
	        	...
	        	this.setOcelotType(((Ocelot) pet).getCatType());
	        }else if(pet instanceof Parrot){
