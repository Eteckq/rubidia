...
public class Required {
	...
	public String getInformation(){
		if(this.getType().equals(RequiredType.LEVEL))return String.valueOf(this.getLevel());
		else if(this.getType().equals(RequiredType.CLASS))return this.getRclass().toString();
		else if(this.getType().equals(RequiredType.JOB) || this.getType().equals(RequiredType.NON_JOB))return this.getRjob().toString();
		...
		else if(this.getType().equals(RequiredType.TIME))return "Between " + this.getTimeStart() + " & " + this.getTimeEnd();
		else if(this.getType().equals(RequiredType.ITEM))return this.getItemStack().getAmount() + " " + (this.getItemStack().getItemMeta().hasDisplayName() ? this.getItemStack().getItemMeta().getDisplayName() : this.getItemStack().getType().toString());
		else if(this.getType().equals(RequiredType.NON_ACTIVE_QUEST))return this.getQuestTarget().getColoredTitle();
		else if(this.getType().equals(RequiredType.NON_DONE_QUEST))return this.getQuestTarget().getColoredTitle();
		else if(this.getType().equals(RequiredType.MASTERY))return this.getMastery().toString();
		return "";
	}
