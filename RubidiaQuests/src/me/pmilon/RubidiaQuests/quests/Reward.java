...
public class Reward {
	...
	public void make(final RPlayer rp){
		if(this.getType().equals(RewardType.CLASS)){
			...
			PNJDialog dialog = new PNJDialog(rp.getPlayer(), pnj, DialogManager.getDialog(rp.getPlayer()).getTalker(), getQuestTarget().getPreDialogs(), DialogType.PREDIALOG, new Runnable(){
				public void run(){
	...
	public String getInformation() {
		...
		else if(this.getType().equals(RewardType.XP))return String.valueOf(this.getRExp());
