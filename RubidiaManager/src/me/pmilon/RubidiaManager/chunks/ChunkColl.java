...
public class ChunkColl {
	...
	public Chunk get(org.bukkit.Chunk chk){
		for(Chunk chunk : chunks){
			if(chunk.getWorld().equals(chk.getWorld()) && chunk.getX() == chk.getX() && chunk.getZ() == chk.getZ())return chunk;
		}
		return null;
	}
	...
	public Chunk get(World world, int x, int z){
		for(Chunk chunk : chunks){
			if(chunk.getWorld().equals(world) && chunk.getX() == x && chunk.getZ() == z)return chunk;
		}
		return null;
	}
